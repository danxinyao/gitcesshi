...
export default {
    ...
    methods: {
        ...
        getSelectGoodsConfigListPage(){
            ...
            ajax.selectGoodsConfigListPage(this.query).then((result)=>{
                console.log(result)
                this.goodsrebatesList = result.dataList
        ...
        search() {
            this.page = 1
            console.log(this.query)
            this.getSelectGoodsConfigListPage()
        },
        // 全选
