...
export default {
    ...
    methods: {
        ...
        querySibIntroConfig() {
            ...
            ajax.selectSkipLevelIntroConfig(this.query)
                .then((result) => {
        ...
        search() {
            ...
            //this.query.condition.editTimeRange.eitTimeBegin = this.query.condition.time[0]//起始时间
            //this.query.condition.editTimeRange.editTimeEnd = this.query.condition.time[1]//截止时间
