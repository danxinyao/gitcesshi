<template>
    <pg-box :isShowBox="show" @close="close">
        ...
        <!-- 导入唯一码的操作区 -->
        <div v-if="btnType === 2">
            <p class="oederNu">订单号：1 170510 4898 0001</p>
            <el-button class="import_btn">导入</el-button>
            <el-table :data="goodList" highlight-current-row border style="width: 80%" class="goodTable">
                <el-table-column align="center" prop="" label="商品货号" width="150">
                </el-table-column>
                <el-table-column align="center" prop="" label="sku" width="150">
                </el-table-column>
                <el-table-column align="center" prop="" label="数量" width="100">
                </el-table-column>
                <el-table-column align="center" prop="" label="唯一码" min-width="250">
