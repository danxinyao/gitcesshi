<template>
	...
	<div class="sendorder">
            ...
            <el-tabs type="border-card" v-model="activeName" @tab-click="handleClick">
				...
				<div class="button_type">
		            ...
		            <div class="button_type_item" v-if="type ===0">
		                ...
		                <el-button type="default" size="small" @click="">导入快递单号</el-button>
		                <el-button type="default" size="small"  @click="">打印快递单</el-button>
		                <el-button type="default" size="small"  @click="printOrder">打印订单</el-button>
		                <el-button type="default" size="small"  @click="">导出订单信息</el-button>
        ...
        <!-- 编辑sku弹窗页 -->
        <pg-skuedit :title="editTitle" :btnType="btnType" :show="showSkuEdit" @refresh="refresh" :editForm="editSkuForm" @closeSkuEdit="closeSkuEdit"></pg-skuedit>
	</div>
</template>
