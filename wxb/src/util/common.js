...
/**
 * 下载上传模板
 * @param type {number} 需要下载的模板类型
 * @param url {string} 需要下载的url地址
 */
export const downloadFile = function(type,url) {
    const method = url ? url : '/Import/ErpGetExcelFile';
...
export const exportFile = function(type,query,url) {
